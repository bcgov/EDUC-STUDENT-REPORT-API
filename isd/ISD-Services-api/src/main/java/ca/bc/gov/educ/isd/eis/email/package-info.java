...
/** Service contract definitions for communications channel adaptors which 
 * transmit (or receive) messages to users via e-mail.
 */
package ca.bc.gov.educ.isd.eis.email;
