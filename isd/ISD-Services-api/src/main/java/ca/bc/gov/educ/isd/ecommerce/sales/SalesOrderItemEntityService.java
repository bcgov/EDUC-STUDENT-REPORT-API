 ...
 */
public interface SalesOrderItemEntityService extends CommonEntityService<SalesOrderItem, SearchResult> {

    SalesOrderItem writeWithDeliveryInfo(SalesOrderItem salesOrderItem, Long deliveryInfoId) throws DomainServiceException, DataException;
}
