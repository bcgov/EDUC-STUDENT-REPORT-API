...
/** Administrative interface for Manual Order Item Delivery information.
 *
 * @author Ministry of Education, BC
 */
public interface ManualDeliveryInfoAdmin extends ManualDeliveryInfo, DeliveryInfoAdmin {
