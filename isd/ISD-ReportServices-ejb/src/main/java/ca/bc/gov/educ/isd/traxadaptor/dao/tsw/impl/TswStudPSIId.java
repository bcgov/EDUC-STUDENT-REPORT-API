 ...
 * primary key for {@code TswStudPSIEntity}.
 *
 * @author CGI Information Management Consultants Inc.
 */
@Embeddable
public class TswStudPSIId implements Serializable {

    // ------------------ CONSTANT(S) AND FINAL(S)
    private static final long serialVersionUID = 1L;
    private static final String CLASSNAME = TswStudPSIId.class.getName();
     ...
     */
    public TswStudPSIId(String studNo, String psiCode, String psiYear) {
        this.studNo = studNo;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TswStudPSIId)) {
            return false;
        }
        final TswStudPSIId other = (TswStudPSIId) object;
        if (!this.studNo.equals(other.studNo)) {
            return false;
        } else if (!this.psiCode.equals(other.psiCode)) {
            return false;
        } else if (!this.psiYear.equals(other.psiYear)) {
            return false;
        }
        return true;
    }
