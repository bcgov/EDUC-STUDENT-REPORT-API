...
public class RoleGroupNames {
     ...
     */
    public static final String REPORTSERVICES_USER = "REPORTSERVICES_USER";

    /**
     * RoleGroup for Administration of Report Services.
     */
    public static final String REPORTSERVICES_ADMIN = "REPORTSERVICES_ADMIN";
