 ...
 */
@Entity
@Table(name = ENTITY_STUDENT_PSI)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TswStudPSIEntity.findAll", query = "SELECT t FROM TswStudPSIEntity t"),
    @NamedQuery(name = "TswStudPSIEntity.findByStudNo", query = "SELECT t FROM TswStudPSIEntity t WHERE t.tswStudPsiId.studNo = :studNo"),
    @NamedQuery(name = "TswStudPSIEntity.findByPsiCode", query = "SELECT t FROM TswStudPSIEntity t WHERE t.tswStudPsiId.psiCode = :psiCode"),
    @NamedQuery(name = "TswStudPSIEntity.findByPsiYear", query = "SELECT t FROM TswStudPSIEntity t WHERE t.tswStudPsiId.psiYear = :psiYear"),
    @NamedQuery(name = "TswStudPSIEntity.findByDateEntered", query = "SELECT t FROM TswStudPSIEntity t WHERE t.dateEntered = :dateEntered"),
    @NamedQuery(name = "TswStudPSIEntity.findByPsiStatus", query = "SELECT t FROM TswStudPSIEntity t WHERE t.psiStatus = :psiStatus")})
public class TswStudPSIEntity implements TSWStud {
    ...
    @Column(name = COL_PSI_DATE_ENTERED)
