 ...
 */
@Entity
@Table(name = ENTITY_STUDENT_PSI_CHOICES)
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "TswPSIChoiceEntity.findAll", query = "SELECT t FROM TswPSIChoiceEntity t"),
    @NamedQuery(name = "TswPSIChoiceEntity.findByStudNo", query = "SELECT t FROM TswPSIChoiceEntity t WHERE t.tswChoiceId.studNo = :studNo"),
    @NamedQuery(name = "TswPSIChoiceEntity.findByPsiCode", query = "SELECT t FROM TswPSIChoiceEntity t WHERE t.tswChoiceId.psiCode = :psiCode"),
    @NamedQuery(name = "TswPSIChoiceEntity.findByPsiYear", query = "SELECT t FROM TswPSIChoiceEntity t WHERE t.tswChoiceId.psiYear = :psiYear"),
    @NamedQuery(name = "TswPSIChoiceEntity.findByStatus", query = "SELECT t FROM TswPSIChoiceEntity t WHERE t.status = :status"),
    @NamedQuery(name = "TswPSIChoiceEntity.findByDateRange", query = "SELECT t FROM TswPSIChoiceEntity t WHERE t.updateDt BETWEEN :startDate AND :endDate"),
    @NamedQuery(name = "TswPSIChoiceEntity.findByUpdateDt", query = "SELECT t FROM TswPSIChoiceEntity t WHERE t.updateDt = :updateDt")})
public class TswPSIChoiceEntity implements PSIChoice {
    ...
    @Column(name = COL_AUDIT_UPDATED_DATE)
    @Temporal(TemporalType.TIMESTAMP)
    private Date updateDt;
    @Column(name = COL_PSI_NAME)
    private String psiName;
    @Column(name = COL_PSI_TRANSMISSION_MODE)
